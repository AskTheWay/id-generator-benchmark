...
**Strategy cards — live availability and batch sampling (collapsible)**

![Strategy cards with live availability badges and collapsible batch sampling](demo_imgs/Snipaste_2026-09-22_05-16-45.png)

**Benchmark results — QPS and latency quantile charts**

![Benchmark result charts: QPS comparison and P50/P90/P99 latency](demo_imgs/Snipaste_2026-09-22_05-17-07.png)

**Sharding × ID — four scenario cards with tunable params**

![Sharding scenario cards with customizable parameters](demo_imgs/Snipaste_2026-09-22_05-17-36.png)

**Offline sneakernet — site cards, ferry import and collision demo**

![Offline sneakernet: site cards, ferry import and collision anti-pattern](demo_imgs/Snipaste_2026-09-22_05-17-46.png)
...
This README is also available in Chinese: [README.md](README.md).
